...
<iframe
  ...
  src="https://www.youtube.com/embed/84T-Vx5wa34?si=8X2FPyFMaeXHWiaf"
...
FDM is designed for single-player projects. **The menu system itself does not perform any network replication by default**, allowing it to be safely used in networked environments while leaving authoritative state and replication control to the game’s own logic. Developers can freely integrate FDM with replicated inventory, ability, or interaction systems as needed.
